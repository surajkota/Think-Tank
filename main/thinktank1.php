...
<div id="header" style="width:100%; ">
	...
	<center><img  src='../images/think tank.png' width="83%" style='float:none; width:75%';/></center>
	</div>
	...
	<center>
	<ul id='ulist'>
	<li class='list' id='1'><a href="home.php">Home</a></li>
	...
	<div id="if" width="100%" height="800px" scrolling="auto" frameborder="0"><?php include("home_o.php") ?></div>
	</div>
	</div>
